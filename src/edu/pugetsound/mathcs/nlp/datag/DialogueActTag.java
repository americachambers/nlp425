...
public enum DialogueActTag {
	...
	/**
	 * tag question (question asked like a structural statement with a question tag at end)
	 */
	TAG_QUESTION("^g"),
	
	/**
	 * hold (often but not always after a question) ('let me think'; question in response to a question)
	 */
	HOLD("^h"),
	MIMIC_OTHER("^m"),
	...
	/**
	 * Downplaying-reponse-to-sympathy/compliments ("That's all right","that happens")
	 */
	DOWNPLAYING_SYMPATHY("bd"),
	
	/**
	 * reFormulate/summarize; paraphrase/summary of other's utterance (as opposed to a mimic)
	 */
	...
	/**
	 * Apology "Apologies" (this is not the "I'm sorry" of sympathy which is "by")
	 */
	APOLOGY("fa"),
	...
	/**
	 * a descriptive/narrative statement which acts as an affirmative answer to a question
	 */
	...
	/**
	 * a descriptive/narrative statement which acts as a negative answer to a question 
	 */
	...
	/**
	 * a response to a question that is neither affirmative nor negative (often "I don't know")
	 */
	...
	/**
	 * viewpoint, from personal opinions to proposed general facts  (listener could have basis to dispute)
	 */
	VIEWPOINT("sv");
